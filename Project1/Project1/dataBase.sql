...
CREATE DATABASE `project1` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `project1`;
...
(1,	'admin',	AES_ENCRYPT('admin','key12345')),
(2,	'user1',	AES_ENCRYPT('password1','key12345')),
(3,	'user2',	AES_ENCRYPT('password2','key12345'));
